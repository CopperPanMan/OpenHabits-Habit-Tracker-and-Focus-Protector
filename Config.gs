  ...
  return {
    ...
    lockoutOverrides: {
      all_lockouts_off: {
        screenTimeLimit: 24,
        appLockSettings: {
          workday_planning_lockout: "OFF",
          personal_planning_lockout: "OFF",
          night_app_lockout: "OFF",
          morning_app_lockout: "OFF"
        },
        overrideKey: "app_closer"
      },
      night_lockout_relaxed: {
        nightAppLockoutStartTime: 23,
        overrideKey: "app_closer"
      },
      sunday_lockout_rules: {
        screenTimeLimit: 4,
        appLockSettings: {
          morning_app_lockout: "OFF",
          personal_planning_time: 8,
          morning_planning_time: 8
        },
        overrideKey: "app_closer"
      },
      saturday_lockout_rules: {
        screenTimeLimit: 4,
        nightAppLockoutStartTime: 23,
        appLockSettings: {
          morning_app_lockout: "OFF",
